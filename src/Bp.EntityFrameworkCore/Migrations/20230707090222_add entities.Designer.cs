...
namespace Bp.Migrations
{
    ...
    [Migration("20230707090222_add entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bp.Posts.Post", b =>
                {
            ...
            modelBuilder.Entity("Bp.PostsSalary.PostSalary", b =>
                {
                    ...
                    b.HasKey("PostName", "RegionId");

                    b.HasIndex("RegionId");

                    b.ToTable("AppPostsSalary", (string)null);
                });

            modelBuilder.Entity("Bp.Regions.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bp.PostsSalary.PostSalary", b =>
                {
                    b.HasOne("Bp.Posts.Post", "Post")
                        .WithMany("PostSalaries")
                        .HasForeignKey("PostName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bp.Regions.Region", "Region")
                        .WithMany("PostSalaries")
